...
class WavesConfig {
    ...
    initializeControls() {
        // PlayStation 3 XMB authentic color palette
    ...
    addColorSelector() {
        ...
        this.addList("Color Theme", colors, "original", (color) =>
...
function initializeInterfaceToggle() {
    ...
    body.addEventListener("click", (e) => {
        if (body.classList.contains("interface-hidden")) {
            ...
            if (
                !e.target.closest(".interface") &&
                !e.target.closest("#stats-container")
            ) {
